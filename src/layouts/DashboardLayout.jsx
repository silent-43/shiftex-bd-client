...
const DashboardLayout = () => {
  ...
  const { role } = useRole();
  // console.log("in the dashboard role", role);
  ...
  return (
    <div className="min-h-screen bg-base-200">
      ...
      >
        ...
        <div className="h-[calc(100vh-105px)] overflow-y-auto overflow-x-hidden px-1 pb-4">
          {/* ============================== Main Menu ============================== */}
        ...
        {!isSidebarOpen && (
          <button
            ...
            className="absolute bottom-5 left-1/2 hidden -translate-x-1/2 btn btn-sm btn-circle border-none bg-[#03373d] text-[#CAEB66] transition-all duration-300 hover:scale-110 hover:bg-[#07545b] active:scale-90 lg:flex"
            title="Open sidebar"
          >
            <FaBars />
          </button>
